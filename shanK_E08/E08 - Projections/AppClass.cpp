...
void Application::Display(void)
{
	...
	case 3:
		m_pCamera->ResetCamera();
		pos = vector3(40.0f, 0.0f, 0.0f);
		target = vector3(0.0f, 0.0f, 0.0f);
		upwards = vector3(0.0f, 0.0f, -1.0f);
		m_pCamera->SetPositionTargetAndUpward(pos, target, upwards);
		break;
	case 4:
		m_pCamera->ResetCamera();
		pos = vector3(0.0f, 0.0f, -15.0f);
		target = vector3(0.0f, 0.0f, 0.0f);
		upwards = vector3(0.0f, 1.0f, 0.0f);
		m_pCamera->SetPositionTargetAndUpward(pos, target, upwards);
		break;
	case 5:
		m_pCamera->ResetCamera();
