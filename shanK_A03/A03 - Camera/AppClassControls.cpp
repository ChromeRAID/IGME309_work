...
void Application::CameraRotation(float a_fSpeed)
{
	...
	m_pCamera->Yaw(fAngleY, 0.5f);
	m_pCamera->Pitch(fAngleX, 0.5f);
}
//Keyboard
...
#pragma region Camera Position
	...
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::W)) //forward
		...
		m_pCamera->MoveSideways(fSpeed);
	else if (sf::Keyboard::isKeyPressed(sf::Keyboard::E)) //up
		m_pCamera->MoveVertical(-fSpeed);
	else if (sf::Keyboard::isKeyPressed(sf::Keyboard::Q)) //down
		m_pCamera->MoveVertical(fSpeed);
