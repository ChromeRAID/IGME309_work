...
#pragma endregion
	...
	{
		quaternion x;
		if (fMultiplier) { //+- a simple x quaternion to object orientation
			m_v3Rotation.x -= 1.0f;
			x = glm::angleAxis(glm::radians(-1.0f), vector3(-1.0f, 0.0f, 0.0f));
		}
		else {
			m_v3Rotation.x += 1.0f;
			x = glm::angleAxis(glm::radians(1.0f), vector3(1.0f, 0.0f, 0.0f));
		...
		m_qOrientation = m_qOrientation * x;
	}
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Y))
	{
		quaternion y;
		if (fMultiplier) { //+- a simple y quaternion to object orientation
			m_v3Rotation.y -= 1.0f;
			y = glm::angleAxis(glm::radians(-1.0f), vector3(0.0f, -1.0f, 0.0f));
		}
		else {
			m_v3Rotation.y += 1.0f;
			y = glm::angleAxis(glm::radians(1.0f), vector3(0.0f, 1.0f, 0.0f));
		...
		m_qOrientation = m_qOrientation * y;
	}
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Z))
	{
		quaternion z;
		if (fMultiplier) { //+- a simple z quaternion to object orientation
			m_v3Rotation.z -= 1.0f;
			z = glm::angleAxis(glm::radians(-1.0f), vector3(0.0f, 0.0f, -1.0f));
		}
		else {
			m_v3Rotation.z += 1.0f;
			z = glm::angleAxis(glm::radians(-1.0f), vector3(0.0f, 0.0f, 1.0f));
		}
		m_qOrientation = m_qOrientation * z;
	}
